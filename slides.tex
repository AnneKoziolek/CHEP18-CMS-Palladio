...
\begin{itemize}
    ...
    \item Outlook
    \begin{itemize}
        \item We plan to extend our model to include heterogeneous computing resources
        \item Will allow to evaluate the efficiency of different scheduling strategies for these resources
    \end{itemize}
\end{itemize}
