...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Measured and simulated throughputs and CPU efficiency for test data from May 2018}
...
The simulated throughput matches the reference from the with a difference of about 5.6\%.
...
Here, the ramp-up of the simulation is also visible.
The overall average utilization in the simulation deviates from the reference by about 3\%, showing that even the current simplified model is capable of accurately reproducing the metrics introduced above.
