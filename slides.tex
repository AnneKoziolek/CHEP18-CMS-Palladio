	...
	\begin{column}{0.5\textwidth}
        \begin{itemize}
			\item Simulation of CMS computing jobs at GridKa for one week
                \begin{itemize}
                    \item Run in 18 minutes on a laptop
                \end{itemize}
			\item Metrics
            \begin{itemize}
                \item Throughput
...
\frametitle{Outlook}
\begin{itemize}
    \item Extend the current model to be able to simulate heterogeneous and distributed computing resources
    \item Include modeling of challenges due to data-locality and remote data-access
    \item Use the result of these models as an input for
    \begin{itemize}
        \item Design of future scheduling systems
        \item Inclusion at run-time to optimize scheduling
    \end{itemize}
