...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                \item Computing resources used for HEP will be increasingly heterogeneous
                \item Already now the case for centers running user analysis
                \begin{itemize}
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.45\textwidth}
            \begin{itemize}
                \item Already now efficient scheduling for jobs is a challenge
                \item This will become even more important with heterogeneous resources in the future
...
\frametitle{Approach}
    ...
    Create simulation to optimize resource usage and cope with heterogeneity of grid
    \vspace{1em}
	\begin{itemize}
	...
	\begin{column}{0.45\textwidth}
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item Optimizing cloud/HEP infrastructure (chemical computing)
			\end{itemize}
		\end{itemize}
	\end{column}
...
\begin{itemize}
    \item We believe computing resources for user analyses will become more distributed and more heterogeneous in the future
    \item Scheduling will be a key component for the efficient usage
    \item In cooperation with computer scientists at KIT we plan to use the tool Palladio to model and evaluate different scheduling strategies
    \item A proof of concept for the usage of Palladio was performed simulating CMS workflows at the T1 center GridKa
    \begin{itemize}
        \item Fully automated model creation based on CMS workflow monitoring and data from GridKa
        \item We were able to successfully model the current situation at GridKa for key metrics
        \item Will investigate how to model further metrics
    \end{itemize}
    \item We plan to extend the current model to be able to include heterogeneous computing resources
